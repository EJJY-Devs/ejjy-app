			...
			const result = await ProductsService.create(
				{
					...
					is_shown_in_purchases: isShownInPurchases,
					is_shown_in_expenses: isShownInExpenses,
					...
					patronage_system_tag_id: patronageSystemTagId || undefined,
